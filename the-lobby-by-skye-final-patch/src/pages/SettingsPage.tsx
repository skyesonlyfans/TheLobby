      ...
      <div className="grid lg:grid-cols-12 gap-4">
        ...
        <Card className="lg:col-span-12 glass-strong">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <ToolLink title="deps.dev" href="https://deps.dev/" />
            <ToolLink title="Libraries.io" href="https://libraries.io/" />
            <ToolLink title="namae" href="https://namae.dev/" />
            <ToolLink title="IT Tools" href="https://it-tools.tech/" />
          </div>
